...
## Contact / License
- Author: Repository owner (see GitHub project).
- License: (Not specified in repository) — add a LICENSE file if you want to make reuse terms explicit.

---

If you want, I can:
- Produce a cleaned-up README file ready to commit (this is already formatted for README.md).
- Create suggested code fixes (e.g., remove disk I/O for frames and fix the frame counter bug) and open a pull request with the fixes.
- Produce a short changelog or a TODO list as issues for the repository.
